...
module.exports = function(app, redT) {
    ...
    const sendPublicFile = (res, relativePath) => {
    ...
    // Friendly direct links (share like Win11 files).
    app.get(['/index.html', '/home.html'], function(req, res) {
        return sendPublicFile(res, 'index.html');
    });
    app.get(['/main.html', '/play.html'], function(req, res) {
        return sendPublicFile(res, path.join('web', 'index.html'));
    });
