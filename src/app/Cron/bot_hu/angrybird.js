        ...
        Promise.all(arrline.map(function(line) {
            ...
            .then(result => {
                    ...
                    if (line_win.type != null) {
                        if (line_win.win == 4) {
                            ...
                            if (heso == 100) {
                                ...
                                io.sendInHome({ pushnohu: { title: 'Pubg', name: user.name, bet: okHu } });
                ...
                if (!nohu && bet_win >= bet * 10) {
                    io.sendInHome({ news: { t: { game: 'Pubg', users: user.name, bet: bet_win, status: 2 } } });
                }
                ...
                if (bet_win < bet) {
                    ...
                    try {
                        HU.findOne({ game: 'arb', type: bet, red: true }, 'bet', function(err, data) {
                            if (!!data) {
