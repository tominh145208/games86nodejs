...
// Casino
let casino = require('./game/casino');
// Royal
            ...
            DaiLy.findOne({ 'nickname': user.name }, function (err, userDL) {
                ...
                if (!!selfData.casino) {
                    if (userDL) {
                        ...
                        casino(selfClient, selfData.casino);
                    }
                }
                ...
                if (!!selfData.poker) {
                    if (userDL) {
                        ...
                        selfClient.red({
                            notice: {
                                title: 'Thông Báo',
                                text: 'Game tạm thời không khả dụng.'
                            }
                        });
                    }
                }
